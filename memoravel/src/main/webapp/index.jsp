			...
			<div id="carouselExampleAutoplaying" class="carousel slide"
				...
				<div class="carousel-inner">
					<div class="carousel-item active" data-bs-interval="4000"
						...
						<img src="./assets/img/wallpaper/airplane_sunset.png"
							class="d-block w-100" alt="..." />
						<div class="slideText">
							<p>남는건 사진밖에 없어요.</p>
							<p>
								<b class="MEMORAVEL">MEMORAVEL </b>으로 여행계획을 세우고
							</p>
					...
					<div class="carousel-item" data-bs-interval="4000">
						<img src="./assets/img/wallpaper/toy.png" class="d-block w-100"
							alt="..." />
						<div class="slideText">
							<p>
								이웃들의 <b class="MEMORAVEL">MEMORY</b>를 들여다 보고
							</p>
					...
					<div class="carousel-item" data-bs-interval="4000">
						<img src="./assets/img/wallpaper/4k.png" class="d-block w-100"
							alt="..." />
						<div class="slideText">
							<p>
								나의 <b class="MEMORAVEL">MEMORY</b>를 이웃들과 공유하고
							</p>
